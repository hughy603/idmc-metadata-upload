 ...
 */
export function getAuthBaseUrl(region: keyof typeof INFORMATICA_REGIONS = DEFAULT_REGION): string {
 ...
 */
export function getApiBaseUrl(region: keyof typeof API_REGIONS = DEFAULT_REGION): string {
